...
class UpdateExtraPage extends StatefulWidget {
  final Food food;

  const UpdateExtraPage({super.key, required this.food});

  @override
  State<UpdateExtraPage> createState() => _UpdateExtraPageState();
}

class _UpdateExtraPageState extends State<UpdateExtraPage> {
  ...
  void initState() {
    ...
    if (widget.food.caloriesPerSize != null) {
      _calSmallController.text = widget.food.caloriesPerSize?['Pieni'] != null
          ? widget.food.caloriesPerSize!['Pieni'].toString()
          : '';
      _calNormalController.text =
          widget.food.caloriesPerSize?['Normaali'] != null
          ? widget.food.caloriesPerSize!['Normaali'].toString()
          : '';
      _calLargeController.text = widget.food.caloriesPerSize?['Iso'] != null
          ? widget.food.caloriesPerSize!['Iso'].toString()
          : '';
    }
    ...
    _hasSizeCal = widget.food.caloriesPerSize != null;
    _hasSizeSmall = widget.food.caloriesPerSize?['Pieni'] != null;
    _hasSizeNormal = widget.food.caloriesPerSize?['Normaali'] != null;
    _hasSizeLarge = widget.food.caloriesPerSize?['Iso'] != null;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Muokkaa lisuketta')),
